<?php include 'header.php';
	...
	if (isset($_GET['id'])) 
	{
		...
		$sql_blog_count = "select * from blog_table ORDER BY `blog_table`.`id` DESC ";
		$sql_select_blog_count = mysqli_query($con,$sql_blog_count);
		$count = mysqli_num_rows($sql_select_blog_count);


		$sql_blog = "select * from blog_table ORDER BY `blog_table`.`id` DESC limit $id,1";
		$sql_select_blog = mysqli_query($con,$sql_blog);
		$row = mysqli_fetch_assoc($sql_select_blog);
							...
							<div class="col-md-8">
								<div class="blog-single-item">
									...
									<div class="prev-btn col-md-6 col-sm-6 col-xs-6">
										<a href="blog-single.php?id=<?php echo $id-1; ?>"><i class="fa fa-angle-left"></i>Previous</a>
									</div>
								<?php } ?>
								<?php if($id+1<$count) { ?>
									<div class="next-btn col-md-6 col-sm-6 col-xs-6">
										<a href="blog-single.php?id=<?php echo $id+1; ?>">Next<i class="fa fa-angle-right"></i></a>
									</div>
								<?php } ?>
								</div>
